  ...
  const handleBuyPackage = () => {
    ...
    if (paymentUrl) {
      ...
      const message = encodeURIComponent(
        `Halo, saya ingin berlangganan TEXA-TOOLS:\n\n` +
          ...
          <div className="glass rounded-[32px] p-8 max-w-2xl w-full border border-white/20 shadow-2xl max-h-[90vh] overflow-y-auto relative">
            ...
            <div className="space-y-3">
              ...
              {settings.whatsappNumber && (
                <a
                  href={`https://wa.me/${settings.whatsappNumber}?text=${encodeURIComponent('Halo, saya ingin bertanya tentang langganan TEXA-TOOLS')}`}
                  target="_blank"
